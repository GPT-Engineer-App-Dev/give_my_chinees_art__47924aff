...
const Index = () => {
  const bg = useColorModeValue("red.600", "gold.600");
      ...
      <VStack spacing={8} as={Stack} align="stretch">
        ...
        <Box bg={bg} p={8} borderRadius="lg">
          <Center flexDirection="column">
            ...
            <Image src="https://images.unsplash.com/photo-1589047133481-02b4a5327d89?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxkdW1wbGluZ3N8ZW58MHx8fHwxNzA0NDYyNDA5fDA&ixlib=rb-4.0.3&q=80&w=1080" borderRadius="full" boxSize="150px" alt="Dumplings" my={5} />
